(function (root, factory) {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      ui: {
        ...
        importPaintRackCsv: "Import PaintRack CSV",
        paintRackImportReportTitle: "PaintRack import",
        paintRackImportSummary: "{matched} catalogue colours marked owned. {custom} colours not in the catalogue kept as owned. {skipped} rows skipped.",
        paintRackMatched: "Catalogue matches ({count})",
        paintRackNotInCatalogue: "Not in catalogue ({count})",
        paintRackStoredOwned: "kept as owned",
        paintRackSkipped: "Skipped ({count})",
        paintRackMore: "...and {count} more",
        paintRackNone: "None.",
        paintRackLine: "Line {line}",
        paintRackNoColourData: "no catalogue colour data",
        paintRackImportReadFailed: "Could not read the CSV file.",
        close: "Close",
        ...
        ownedBadge: "Owned",
        ownedBadgeLegend: "Owned badge = owned colour",
        shoppingList: "Shopping list",
        shoppingListDescription: "Add unowned colours from tooltips or search the catalogue, then remove them when no longer needed.",
        collapseShoppingList: "Collapse",
        expandShoppingList: "Expand",
        collapseSection: "Collapse",
        expandSection: "Expand",
        shoppingSearch: "Search colours to buy",
        shoppingAddColour: "Add colour",
        addShoppingPaint: "Add to list",
        addToShoppingList: "Add to shopping list",
        inShoppingList: "In shopping list",
        markShoppingPaintOwned: "Mark owned",
        removeShoppingPaint: "Remove",
        shoppingListStatus: "{count} colours on your shopping list.",
        shoppingListEmpty: "Your shopping list is empty.",
        shoppingSearchPlaceholder: "Select an unowned colour ({count})",
        shoppingSearchEmpty: "No unowned colours match the current search.",
    ...
    de: {
      ...
      ui: {
        ...
        importPaintRackCsv: "PaintRack-CSV importieren",
        paintRackImportReportTitle: "PaintRack-Import",
        paintRackImportSummary: "{matched} Katalogfarben als vorhanden markiert. {custom} Farben ohne Katalogtreffer als vorhanden gespeichert. {skipped} Zeilen uebersprungen.",
        paintRackMatched: "Katalogtreffer ({count})",
        paintRackNotInCatalogue: "Nicht im Katalog ({count})",
        paintRackStoredOwned: "als vorhanden gespeichert",
        paintRackSkipped: "Uebersprungen ({count})",
        paintRackMore: "...und {count} weitere",
        paintRackNone: "Keine.",
        paintRackLine: "Zeile {line}",
        paintRackNoColourData: "keine Katalog-Farbdaten",
        paintRackImportReadFailed: "Die CSV-Datei konnte nicht gelesen werden.",
        close: "Schliessen",
        ...
        ownedBadgeLegend: "Vorhanden-Plakette = eigene Farbe",
        shoppingList: "Einkaufsliste",
        shoppingListDescription: "Füge nicht vorhandene Farben aus Tooltips oder per Katalogsuche hinzu und entferne sie bei Bedarf wieder.",
        collapseShoppingList: "Einklappen",
        expandShoppingList: "Ausklappen",
        collapseSection: "Einklappen",
        expandSection: "Ausklappen",
        shoppingSearch: "Farben zum Kaufen suchen",
        shoppingAddColour: "Farbe hinzufügen",
        addShoppingPaint: "Zur Liste",
        addToShoppingList: "Zur Einkaufsliste",
        inShoppingList: "Auf der Einkaufsliste",
        markShoppingPaintOwned: "Als vorhanden markieren",
        removeShoppingPaint: "Entfernen",
        shoppingListStatus: "{count} Farben auf deiner Einkaufsliste.",
        shoppingListEmpty: "Deine Einkaufsliste ist leer.",
        shoppingSearchPlaceholder: "Nicht vorhandene Farbe auswählen ({count})",
        shoppingSearchEmpty: "Keine nicht vorhandenen Farben passen zur aktuellen Suche.",
    ...
    fr: {
      ...
      ui: {
        ...
        importPaintRackCsv: "Importer CSV PaintRack",
        paintRackImportReportTitle: "Import PaintRack",
        paintRackImportSummary: "{matched} couleurs du catalogue marquees comme possedees. {custom} couleurs absentes du catalogue gardees comme possedees. {skipped} lignes ignorees.",
        paintRackMatched: "Correspondances catalogue ({count})",
        paintRackNotInCatalogue: "Absentes du catalogue ({count})",
        paintRackStoredOwned: "gardee comme possedee",
        paintRackSkipped: "Ignorees ({count})",
        paintRackMore: "...et {count} de plus",
        paintRackNone: "Aucune.",
        paintRackLine: "Ligne {line}",
        paintRackNoColourData: "aucune donnee couleur du catalogue",
        paintRackImportReadFailed: "Impossible de lire le fichier CSV.",
        close: "Fermer",
        ...
        ownedBadge: "Possédée",
        ownedBadgeLegend: "Badge Possédée = couleur possédée",
        shoppingList: "Liste d'achat",
        shoppingListDescription: "Ajoute des couleurs non possédées depuis les infobulles ou la recherche du catalogue, puis retire-les au besoin.",
        collapseShoppingList: "Replier",
        expandShoppingList: "Déplier",
        collapseSection: "Replier",
        expandSection: "Déplier",
        shoppingSearch: "Chercher des couleurs à acheter",
        shoppingAddColour: "Ajouter une couleur",
        addShoppingPaint: "Ajouter",
        addToShoppingList: "Ajouter à la liste",
        inShoppingList: "Dans la liste",
        markShoppingPaintOwned: "Marquer possédée",
        removeShoppingPaint: "Retirer",
        shoppingListStatus: "{count} couleurs dans ta liste d'achat.",
        shoppingListEmpty: "Ta liste d'achat est vide.",
        shoppingSearchPlaceholder: "Choisir une couleur non possédée ({count})",
        shoppingSearchEmpty: "Aucune couleur non possédée ne correspond à la recherche.",
    ...
    es: {
      ...
      ui: {
        ...
        importPaintRackCsv: "Importar CSV de PaintRack",
        paintRackImportReportTitle: "Importacion PaintRack",
        paintRackImportSummary: "{matched} colores del catalogo marcados como propios. {custom} colores fuera del catalogo guardados como propios. {skipped} filas omitidas.",
        paintRackMatched: "Coincidencias de catalogo ({count})",
        paintRackNotInCatalogue: "Fuera del catalogo ({count})",
        paintRackStoredOwned: "guardado como propio",
        paintRackSkipped: "Omitidos ({count})",
        paintRackMore: "...y {count} mas",
        paintRackNone: "Ninguno.",
        paintRackLine: "Linea {line}",
        paintRackNoColourData: "sin datos de color del catalogo",
        paintRackImportReadFailed: "No se pudo leer el archivo CSV.",
        close: "Cerrar",
        ...
        ownedBadge: "Propio",
        ownedBadgeLegend: "Insignia Propio = color propio",
        shoppingList: "Lista de compra",
        shoppingListDescription: "Añade colores que no tienes desde los tooltips o buscando en el catálogo, y elimínalos cuando quieras.",
        collapseShoppingList: "Contraer",
        expandShoppingList: "Expandir",
        collapseSection: "Contraer",
        expandSection: "Expandir",
        shoppingSearch: "Buscar colores para comprar",
        shoppingAddColour: "Añadir color",
        addShoppingPaint: "Añadir",
        addToShoppingList: "Añadir a la lista",
        inShoppingList: "En la lista",
        markShoppingPaintOwned: "Marcar como propio",
        removeShoppingPaint: "Quitar",
        shoppingListStatus: "{count} colores en tu lista de compra.",
        shoppingListEmpty: "Tu lista de compra está vacía.",
        shoppingSearchPlaceholder: "Selecciona un color que no tienes ({count})",
        shoppingSearchEmpty: "Ningún color no propio coincide con la búsqueda.",
  ...
  const ITALIAN_TRANSLATIONS = {
    ...
    ui: {
      ...
      importPaintRackCsv: "Importa CSV PaintRack",
      paintRackImportReportTitle: "Import PaintRack",
      paintRackImportSummary: "{matched} colori del catalogo segnati come posseduti. {custom} colori fuori catalogo salvati come posseduti. {skipped} righe saltate.",
      paintRackMatched: "Corrispondenze catalogo ({count})",
      paintRackNotInCatalogue: "Fuori catalogo ({count})",
      paintRackStoredOwned: "salvato come posseduto",
      paintRackSkipped: "Saltate ({count})",
      paintRackMore: "...e altri {count}",
      paintRackNone: "Nessuno.",
      paintRackLine: "Riga {line}",
      paintRackNoColourData: "nessun dato colore del catalogo",
      paintRackImportReadFailed: "Impossibile leggere il file CSV.",
      close: "Chiudi",
      ...
      ownedBadgeLegend: "Etichetta Posseduto = colore posseduto",
      shoppingList: "Lista della spesa",
      shoppingListDescription: "Aggiungi colori non posseduti dai tooltip o cercando nel catalogo, poi rimuovili quando vuoi.",
      collapseShoppingList: "Comprimi",
      expandShoppingList: "Espandi",
      collapseSection: "Comprimi",
      expandSection: "Espandi",
      shoppingSearch: "Cerca colori da comprare",
      shoppingAddColour: "Aggiungi colore",
      addShoppingPaint: "Aggiungi",
      addToShoppingList: "Aggiungi alla lista",
      inShoppingList: "Nella lista",
      markShoppingPaintOwned: "Segna posseduto",
      removeShoppingPaint: "Rimuovi",
      shoppingListStatus: "{count} colori nella lista della spesa.",
      shoppingListEmpty: "La lista della spesa è vuota.",
      shoppingSearchPlaceholder: "Seleziona un colore non posseduto ({count})",
      shoppingSearchEmpty: "Nessun colore non posseduto corrisponde alla ricerca.",
